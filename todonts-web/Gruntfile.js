...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      emberTemplates: {
        files: '<%= yeoman.app %>/scripts/templates/**/*.handlebars',
      ...
      unit: {
        options: {
          ...
          files: [
            ...
            'app/scripts/lib/activemodel-adapter.js',
            'app/bower_components/momentjs/moment.js',
            '.tmp/scripts/combined-templates.js',
    ...
    emberTemplates: {
      ...
      dist: {
        files: {
          '.tmp/scripts/compiled-templates.js': '<%= yeoman.app %>/scripts/templates/{,*/}*.handlebars'
        }
      }
    },
    neuter: {
